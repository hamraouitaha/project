...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 14 déc. 2018 à 13:08
...
--
-- Déchargement des données de la table `est_ouverte`
--
...
--
-- Structure de la table `loginnew`
--
...
CREATE TABLE `loginnew` (
  ...
  `confgpassword` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `loginnew`
--

INSERT INTO `loginnew` (`id`, `username`, `password`, `confgpassword`) VALUES
(1, 'taha', '123456789', '123456789'),
(2, 'chedli', '123456789', '123456789'),
(4, 'toutou', '1234', '1234'),
(5, 'hamraoui', '12345', '12345'),
(6, 'marouen', '120', '120'),
(7, '$login', '$password', '$confgpassword'),
(8, '$username', '$password', '$confgpassword'),
(9, 'fitness', 'fb2fcd534b0ff3bbed73cc51df620323', ''),
(10, 'salemn', '5f4dcc3b5aa765d61d8327deb882cf99', ''),
(11, 'MAX', '5f4dcc3b5aa765d61d8327deb882cf99', '');
...
--
-- Index pour la table `loginnew`
--
ALTER TABLE `loginnew`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `loginnew`
--
ALTER TABLE `loginnew`
